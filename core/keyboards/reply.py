...
],resize_keyboard=True,one_time_keyboard=True,input_field_placeholder="Выбери команду:",selective=True)
...
loc_tel_poll_keyboard = ReplyKeyboardMarkup(keyboard=[
    ...
    input_field_placeholder="Отправить локацию/контакт или создать викторину")
